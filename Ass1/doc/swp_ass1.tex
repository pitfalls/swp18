...
\hline 
$X_2$ & $X_2 \rightarrow V $& $X_2 \rightarrow V$ & $X_2 \rightarrow W $& $X2 \rightarrow W $& $X_2 \rightarrow W $&  &  \\ 
\hline 
$Y$ &   &   &   &   & $Y \rightarrow \underline{+} Y_2 $&   &   \\ 
\hline 
$Y_2$ &   &   &   &   &   & $Y_2 \rightarrow \underline{y} W \underline{-} Y_2 $& $Y_2 \rightarrow \epsilon$ \\
\hline 
\end{tabular} 
